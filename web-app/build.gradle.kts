...
tasks.register<Copy>("copyFrontendResources") {
    ...
    into(layout.buildDirectory.dir("resources/main/web/app/bytes2png/static"))
}
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            artifactId = "web-app-bytes2png"
            pom {
                packaging = "jar"
                url = "https://github.com/sibdevtools/web-app-bytes2png"
                ...
                scm {
                    connection.set("scm:https://github.com/sibdevtools/web-app-bytes2png.git")
                    developerConnection.set("scm:git:ssh://github.com/sibdevtools")
                    url.set("https://github.com/sibdevtools/web-app-bytes2png")
                }
